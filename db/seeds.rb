...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  	...
  	Club.create(title: "Testing Meeting", date: "September 20, 2014", content: "This is a basic overview of the events the club will be having and asking for inputs", contact: "True")  